...
<script lang="ts">
  ...
  import {getBpmFormSchema,prdIssueDetailColumns} from '../PrdIssue.data';
  import {saveOrUpdate,prdIssueDetailList} from '../PrdIssue.api';
  ...
  export default defineComponent({
    ...
    setup(props){
      ...
      const queryByIdUrl = '/prdissue/prdIssue/queryById';
      async function initFormData(){
        let params = {id: props.formData.dataId};
        const data = await defHttp.get({url: queryByIdUrl, params});
        //设置表单的值
        await setFieldsValue({...data});
        requestSubTableData(prdIssueDetailList, {id: data.id}, prdIssueDetailTable, ()=>{
          prdIssueDetailTable.show = true;
        });
        //默认是禁用
