...
export const columns: BasicColumn[] = [
   ...
   },
   {
    title: '供应商',
    align:"center",
    dataIndex: 'suplierCode_dictText'
   },
   {
    title: '收货单号',
    align:"center",
...
export const superQuerySchema = {
  ...
  suplierCode: {title: '供应商',order: 2,view: 'sel_search', type: 'string',dictTable: "yujiakeji_suppliers", dictCode: 'code', dictText: 'name',},
  receiveCodes: {title: '收货单号',order: 4,view: 'popup', type: 'string',code: '', orgFields: '', destFields: 'receiveCodes', popupMulti: false,},
  ...
  audit: {title: '审核状态',order: 7,view: 'number', type: 'number',dictCode: 'dict_audit_status',},
