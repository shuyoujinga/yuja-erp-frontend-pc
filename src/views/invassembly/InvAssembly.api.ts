...
enum Api {
  list = '/invassembly/invAssembly/list',
  save='/invassembly/invAssembly/add',
  edit='/invassembly/invAssembly/edit',
  deleteOne = '/invassembly/invAssembly/delete',
  deleteBatch = '/invassembly/invAssembly/deleteBatch',
