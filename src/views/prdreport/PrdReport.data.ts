...

  {
    ...
    componentProps: ({formActionType, formModel}) => {
      ...
      return {
        ...
        code: "report_prd_work_main",
        fieldConfig: [
          {source: 'doc_code', target: 'workOrderCodes'},
          {source: 'id', target: 'workOrderIds'},
          {source: 'production_material_code', target: 'materialCode'},
          {source: 'work_qty', target: 'orderQty'},
          {source: 'work_qty', target: 'qty'},
          {source: 'process_type', target: 'processType'},
          {source: 'process_code', target: 'processCode'},
          {source: 'work_type', target: 'workType'},
          {source: 'work_unit_price', target: 'workUnitPrice'},
        ],
        multi: false,
