<template>
  <div>
    ...
    <!-- 表单区域 -->
    <PurOrderModal @register="registerModal" @success="handleSuccess"></PurOrderModal>
  </div>
</template>

<script lang="ts" name="purorder-purOrder" setup>
import {ref, reactive, computed, unref} from 'vue';
import {BasicTable, useTable, TableAction} from '/@/components/Table';
import {useListPage} from '/@/hooks/system/useListPage'
import {useModal} from '/@/components/Modal';
import PurOrderModal from './components/PurOrderModal.vue'
import {columns, searchFormSchema, superQuerySchema} from './PurOrder.data';
import {
  list,
  deleteOne,
  batchDelete,
