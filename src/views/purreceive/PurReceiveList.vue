<template>
  <div>
    ...
    <!-- 表单区域 -->
    <PurReceiveModal @register="registerModal" @success="handleSuccess"></PurReceiveModal>
  </div>
</template>

<script lang="ts" name="purreceive-purReceive" setup>
import {ref, reactive, computed, unref} from 'vue';
import {BasicTable, useTable, TableAction} from '/@/components/Table';
import {useListPage} from '/@/hooks/system/useListPage'
import {useModal} from '/@/components/Modal';
import PurReceiveModal from './components/PurReceiveModal.vue'
import {columns, searchFormSchema, superQuerySchema} from './PurReceive.data';
import {
  list,
  deleteOne,
  batchDelete,
