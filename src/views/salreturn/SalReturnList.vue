<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
     <!--插槽:table标题-->
      <template #tableTitle>
          <a-button type="primary" @click="handleAdd" preIcon="ant-design:plus-outlined"> 新增</a-button>        <!-- 审核/反审核按钮 -->
    ...
    <!-- 表单区域 -->
    <SalReturnModal @register="registerModal" @success="handleSuccess"></SalReturnModal>
  </div>
</template>

<script lang="ts" name="salreturn-salReturn" setup>
  import {ref, reactive, computed, unref} from 'vue';
  import {BasicTable, useTable, TableAction} from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage'
  import {useModal} from '/@/components/Modal';
  import SalReturnModal from './components/SalReturnModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './SalReturn.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl,getAuditUrl} from './SalReturn.api';
