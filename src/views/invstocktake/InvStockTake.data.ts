...
export const superQuerySchema = {
  docCode: {title: '盘点单号',order: 0,view: 'text', type: 'string',},
  docTime: {title: '制单日期',order: 1,view: 'text', type: 'string',},
  warehouseCode: {title: '仓库',order: 2,view: 'text', type: 'string',},
  areaCode: {title: '库区',order: 3,view: 'text', type: 'string',},
  locationCode: {title: '库位',order: 4,view: 'text', type: 'string',},
  ...
  invStockTakeDetail: {
    ...
    fields: {
        ...
        bookQty: {title: '账面数',order: 4,view: 'number', type: 'number',},
        qty: {title: '盘点数',order: 5,view: 'number', type: 'number',},
        diffQty: {title: '差异数',order: 6,view: 'number', type: 'number',},
        takeType: {title: '盘点类型',order: 7,view: 'number', type: 'number',},
