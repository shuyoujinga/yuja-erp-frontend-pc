...
enum Api {
  list = '/salsettle/salSettle/list',
  save='/salsettle/salSettle/add',
  edit='/salsettle/salSettle/edit',
  deleteOne = '/salsettle/salSettle/delete',
  deleteBatch = '/salsettle/salSettle/deleteBatch',
