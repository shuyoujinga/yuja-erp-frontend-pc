    ...
    <a-tabs v-model:activeKey="activeKey" animated  @change="handleChangeTabs">
          <a-tab-pane tab="生产工序_明细" key="prdProcessDetail" :forceRender="true">
            <JVxeTable
              ...
              v-if="prdProcessDetailTable.show"
...
<script lang="ts">
  ...
  import {getBpmFormSchema,prdProcessDetailColumns} from '../PrdProcess.data';
  ...
  export default defineComponent({
    ...
    setup(props){
      ...
      async function initFormData(){
        ...
        requestSubTableData(prdProcessDetailList, {id: data.id}, prdProcessDetailTable, ()=>{
          prdProcessDetailTable.show = true;
        });
        //默认是禁用
