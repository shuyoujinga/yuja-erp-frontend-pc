...
<script lang="ts" setup>
    ...
    import {formSchema,invMaterialVoucherDetailColumns} from '../InvMaterialVoucher.data';
    ...
    const [registerModal, {setModalProps, closeModal}] = useModalInner(async (data) => {
        ...
        if (unref(isUpdate)) {
            ...
            await setFieldsValue({
             ...
             requestSubTableData(invMaterialVoucherDetailList, {id:data?.record?.id}, invMaterialVoucherDetailTable)
        }
        // 隐藏底部时禁用整个表单
    ...
    async function reset(){
      await resetFields();
      activeKey.value = 'invMaterialVoucherDetail';
      invMaterialVoucherDetailTable.dataSource = [];
    }
