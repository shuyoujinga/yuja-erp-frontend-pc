<template>
  <div>
    ...
    <!-- 表单区域 -->
    <PurApplyModal @register="registerModal" @success="handleSuccess"></PurApplyModal>
  </div>
</template>

<script lang="ts" name="purapply-purApply" setup>
import {ref, reactive, computed, unref} from 'vue';
import {BasicTable, useTable, TableAction} from '/@/components/Table';
import {useListPage} from '/@/hooks/system/useListPage'
import {useModal} from '/@/components/Modal';
import PurApplyModal from './components/PurApplyModal.vue'
import {columns, searchFormSchema, superQuerySchema} from './PurApply.data';
import {list, deleteOne, batchDelete, getImportUrl, getExportUrl,getAuditUrl} from './PurApply.api';
