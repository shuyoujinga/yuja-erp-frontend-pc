...
export const invDisassemblyBomDetailColumns: JVxeColumn[] = [
  {
    title: 'BOM编码',
    key: 'bomCode',
    type: JVxeTypes.input,
...
export const superQuerySchema = {
  ...
  invDisassemblyBomDetail: {
    ...
    fields: {
      ...
      standardQty: {title: '标准用量', order: 6, view: 'text', type: 'string',},
      qty: {title: '数量', order: 7, view: 'text', type: 'string',},
      unitPrice: {title: '单价', order: 8, view: 'text', type: 'string',},
      amount: {title: '金额', order: 9, view: 'text', type: 'string',},
