...
<style lang="less" scoped>
  ...
  .aui-phone-logo h2 {
    display: flex; /* 使 h4 元素内的内容使用 flexbox 布局 */
    align-items: center; /* 确保 h4 内部的内容也垂直居中对齐 */
    margin: 0; /* 去掉 h4 元素的默认 margin */
    white-space: nowrap; /* 防止 h4 内容换行 */
    font-weight: bold;
    font-size: 35px;
  }
  ...
  .aui-phone-logo img {
    ...
    vertical-align: middle; /* 确保图像垂直居中对齐 */
  }
