<template>
  <div>
    ...
    <!-- 表单区域 -->
    <PurSupplierQuotationModal @register="registerModal"
                               @success="handleSuccess"></PurSupplierQuotationModal>
  </div>
</template>

<script lang="ts" name="supplierquotation-purSupplierQuotation" setup>
import {ref, reactive, computed, unref} from 'vue';
import {BasicTable, useTable, TableAction} from '/@/components/Table';
import {useListPage} from '/@/hooks/system/useListPage'
import {useModal} from '/@/components/Modal';
import PurSupplierQuotationModal from './components/PurSupplierQuotationModal.vue'
import {columns, searchFormSchema, superQuerySchema} from './PurSupplierQuotation.data';
import {list, deleteOne, batchDelete, getImportUrl, getExportUrl,getAuditUrl} from './PurSupplierQuotation.api';
...
const {prefixCls, tableContext, onExportXls, onImportXls, onAudit} = useListPage({
  tableProps: {
    ...
    formConfig: {
      ...
      fieldMapToNumber: [],
      fieldMapToTime: [
        ['docTime', ['docTime_begin', 'docTime_end'], 'YYYY-MM-DD'],
      ],
    },
    actionColumn: {
      width: 120,
