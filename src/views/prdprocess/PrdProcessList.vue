<template>
  <div>
    ...
    <!--字典弹窗-->
    <PrdProcessModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="prdprocess-prdProcess" setup>
  //ts语法
  import {ref, reactive, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import PrdProcessModal from './components/PrdProcessModal.vue';
  import {columns, searchFormSchema, superQuerySchema} from './PrdProcess.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deletePrdProcess, batchDeletePrdProcess, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './PrdProcess.api';
  ...
  async function handleDelete(record) {
    await deletePrdProcess({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeletePrdProcess({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
