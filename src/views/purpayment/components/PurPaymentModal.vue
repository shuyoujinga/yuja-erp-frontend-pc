...
<script lang="ts" setup>
    ...
    import {formSchema,purPaymentDetailColumns} from '../PurPayment.data';
    ...
    const [registerModal, {setModalProps, closeModal}] = useModalInner(async (data) => {
        ...
        if (unref(isUpdate)) {
            ...
            await setFieldsValue({
             ...
             requestSubTableData(purPaymentDetailList, {id:data?.record?.id}, purPaymentDetailTable)
        }
        // 隐藏底部时禁用整个表单
    ...
    async function reset(){
      await resetFields();
      activeKey.value = 'purPaymentDetail';
      purPaymentDetailTable.dataSource = [];
    }
